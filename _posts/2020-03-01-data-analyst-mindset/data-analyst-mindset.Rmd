...
While neither of these examples directly imply immediate clinical utility, these illustrate the fact that without domain expertise from subject matter experts, we may simply be applying ML on medical datasets, rather than applying ML for the betterment of health.

# "Hippocratic Oath" for Data Analysis
