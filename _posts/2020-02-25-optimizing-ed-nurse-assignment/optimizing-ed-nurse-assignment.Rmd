---
title: "Optimizing ED Nurse Assignment"
description: |
  Implementing an optimization tool for ED nurse assignment.
author:
  - name: David Dai and Neal Kaw
    affiliation: Data Science & Advanced Analytics, St. Michael's Hospital
    affiliation_url: https://www.chartdatascience.ca/
date: '2019-06-15'
output:
...
- Shiny
- healthcare
categories: R, Shiny, Healthcare, Implementation
---
...
knitr::include_graphics("ed-rn.jpg")
```
